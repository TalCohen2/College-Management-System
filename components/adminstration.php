<div class="col-md-12 rows">
  <div class="col-md-2 adminshow">
    <h3>Administrators<a href="/talcohenproject/adminstration/addAdmin" class="pull-right glyphicon glyphicon-plus"></a></h3>
    ...
    <?php
      ...
      for($i=0;$i<count($admins);$i++) {
        ...
        echo <<<HTM
        <a class="list-group-item list-group-item-action col-md-12" href="/talcohenproject/adminstration/edit/{$admins[$i]['id']}"><li>
          <li>
          <section class="col-md-3">
            <img src='/talcohenproject/image/{$admins[$i]['image']}'>
          </section>
