...
if(f.elements.add) {
    f.elements.add.onclick = function() {
        if(validation()) {
            f.action ='/talcohenproject/adminstration/manageadmin/add';
            f.submit();
        }
    }
}
...
if(f.elements.edit) {
    f.elements.edit.onclick = function(e) {
        if(validation()) {
            ...
            f.action ='/talcohenproject/adminstration/manageadmin/edit/' + id;
            f.submit();
        }
    }
}
...
if(f.elements.delete) {
    f.elements.delete.onclick = function(e) {
        if(confirm("are you sure?")) {
            ...
            location.href = "/talcohenproject/adminstration/manageadmin/delete/" + id;
        }
    }
}
